...
<?php
if(!isset($_SESSION['customer_email'])){
  echo '<a href="customer_register.php" class="login__link">User Register</a>';
} 
  else
  { 
...
<?php
if(!isset($_SESSION['customer_email'])){
  echo '<a href="checkout.php" class="login__link">User Sign In</a>';
} 
  else
  { 
...
<?php
if(!isset($_SESSION['customer_email'])){
  echo '<a href="./admin_area" class="login__link">Admin Sign In</a>';
} 
  else
  { 
